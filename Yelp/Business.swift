...
class Business: NSObject {
    ...
    @objc let distance: String?
    @objc let ratingImageURL: URL?
    @objc let reviewCount: NSNumber?
    ...
    @objc class func businesses(array: [NSDictionary]) -> [Business] {
    ...
    @objc class func searchWithTerm(term: String, completion: @escaping ([Business]?, Error?) -> Void) {
